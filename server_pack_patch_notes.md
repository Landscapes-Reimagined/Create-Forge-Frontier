...
- Multiplayer-ready configuration for the official gameplay experience
...
- Better Combat compatibility improvements
- Additional stability and quality-of-life fixes

For the complete list of major gameplay additions introduced in *The Final Frontier*, see:

- https://github.com/Landscapes-Reimagined/Create-Forge-Frontier/blob/main/changelogs/3.0.0_Highlights.md
- https://github.com/Landscapes-Reimagined/Create-Forge-Frontier/blob/main/changelogs/3.0.0_Changelog.md
- https://github.com/Landscapes-Reimagined/Create-Forge-Frontier/blob/main/changelogs/3.0.0_Mod_Updates.md
...
- Updated compatibility across multiple mods
- Fixed quest-related issues
- Improved configuration consistency
- Updated supporting libraries
- Numerous maintenance fixes throughout the pack

---

## **Need Help?**

If you encounter installation issues, server setup questions, or gameplay bugs, join our official **Discord Community**:
