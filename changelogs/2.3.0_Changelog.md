...
- **[BaguetteLib](https://www.curseforge.com/minecraft/mc-mods/baguettelib)**
  Library Mod required for Corpse Compat
...
- **[Create: Dreams n' Desires Updated to Create 6](https://www.curseforge.com/minecraft/mc-mods/create-dreams-n-desires-updated-to-create-6)**
  Allows **Create: Dreams n' Desires** to run with Create Update 6.0
...
### 🔄 **[Click here to view the full list of Mod Updates](https://github.com/Landscapes-Reimagined/Create-Forge-Frontier/blob/main/changelogs/2.3.0_Mod_Updates.md)**  
---
...
- Updated to Create 6.0
- Changed Energetic Blaze Burners to use 20 ae/t constantly for Infusion, eliminated cost from recipes
- Properly set render types
- Fixed Dreams n' Desires belts
- Removed Create: Balanced Flight
- Changed modid to forgefrontiercore
- Added Copper Jetpack to the Jetpack Curio slot  
---
...
- Master Pieces of the Unseen: Completed Chapter *
- Web of Connections: Completed Chapter *
- Dreams of Innovation: Completed Chapter *
### Imcomplete Quests
...
- Fixed Structure Gen for **IDAS** Nether Ancient Portal and Foxhound Den, so they now spawn properly
...
- Added:
  ...
  - Mixing Recipes for basic AE2 items
  - Missing Tags for Resonite 
  - Gave Advanced AE Quantum Armor Anti Radiation Tag for Create Nuclear
- Adjusted:
...
### **Create: DD**
- Increased Stress capacity of the kinetic motor to 4.0
### **FTB**
- Lowered Distance and cooldown of RTP
### **Memory Settings**
- Updated Values to properly convert GB to MiB 
### **CarryOn** 
- Blacklisted all Create Addon blocks, and also create packages
