ServerEvents.recipes(event => 
    {
        ...
        // Master toggle for ALL stone type recycling recipes
        const ENABLE_STONE_RECYCLING = true;
        ...
        // stoneType: false  -> disables recycling recipe for THAT entry only
        const stones = [
        ...
        stones.forEach(stone => {
            ...
            // Recycling Recipe (master toggle + per-stone toggle)
            if (ENABLE_STONE_RECYCLING && stone.stoneType !== false) {
                event.custom({
                    type: "create:crushing",
