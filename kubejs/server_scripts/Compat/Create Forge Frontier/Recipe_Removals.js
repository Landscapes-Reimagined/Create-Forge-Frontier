ServerEvents.recipes(event => 
	{
		...
		event.remove({ id: 'fluid:stonezone/c/unusualend/cut_gloopslate_wall'})
		event.remove({ id: 'create_connected:item_application/ending_catalyst_dragons_breath_from_empty_using_deployer' })
		event.remove({ id: 'create_connected:item_application/ending_catalyst_dragons_breath_from_empty' })		
