ServerEvents.tags('item', event => 
    {
        ...
        // New Elytra Curios Tag
            event.add("curios:elytras", "#elytraslot:elytra")
        ...
        // Crafting Tables
            const craftingTables = [
                "alpha_crafting_table", 
                "baobab_crafting_table", 
                "blackwood_crafting_table", 
                "blue_bioshroom_crafting_table",
                "brimwood_crafting_table", 
                "cobalt_crafting_table", 
                "cypress_crafting_table", 
                "ru_dead_crafting_table",
                "eucalyptus_crafting_table", 
                "green_bioshroom_crafting_table", 
                "joshua_crafting_table", 
                "kapok_crafting_table",
                "larch_crafting_table", 
                "magnolia_crafting_table", 
                "maple_crafting_table", 
                "mauve_crafting_table",
                "ru_palm_crafting_table", 
                "pine_crafting_table", 
                "pink_bioshroom_crafting_table", 
                "ru_redwood_crafting_table",
                "ru_willow_crafting_table", 
                "yellow_bioshroom_crafting_table", 
                "socotra_crafting_table"
            ];
        ...
        // Ad Astra Ores
            ...
            // Desh Ore
                event.add("forge:ores/desh", [
                    "ad_astra:moon_desh_ore",
                    "ad_astra:deepslate_desh_ore"
                ]);

            // Ostrum Ore
                event.add("forge:ores/ostrum", [
                    "ad_astra:mars_ostrum_ore", 
                    "ad_astra:deepslate_ostrum_ore"
                ]);

            // Calorite Ore 
                event.add("forge:ores/calorite", [
        ...
        // Forge Templates/Smithing
            event.add("forge:templates/smithing", [
                ...
                "create_additions_synthetics:gilded_upgrade", 
                "create_ethium:ethium_smithing_template", 
