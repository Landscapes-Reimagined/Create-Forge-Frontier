ServerEvents.recipes(function (event) {
    ...
    var tableCasts = [
        // Vanilla + base metals
        { name: "iron", fluid: "createmetallurgy:molten_iron", ingot: "minecraft:iron_ingot", nugget: "minecraft:iron_nugget", plate: "create:iron_sheet", rodTag: "forge:rods/iron", wireTag: "forge:wires/iron" },
        { name: "gold", fluid: "createmetallurgy:molten_gold", ingot: "minecraft:gold_ingot", nugget: "minecraft:gold_nugget", plate: "create:golden_sheet", rodTag: "forge:rods/gold", wireTag: "forge:wires/gold" },
        ...
        { name: "etrium", fluid: "forge_frontier:molten_etrium", ingot: "ad_astra:etrium_ingot", nugget: "ad_astra:etrium_nugget", plate: "ad_astra:etrium_plate", rodTag: "forge:rods/etrium", wireTag: "forge:wires/etrium" },
