ServerEvents.recipes(event => { 
   ...
   // Resource Stone Recipes
    const stones = [
        ...
        { name: 'sulphite', input: 'forge_frontier:sulphite', output: 'forge_frontier:crushed_sulphite', rare: true  },
        ...
        { name: 'raw_desh', input: 'ad_astra:raw_desh', output: 'forge_frontier:crushed_aubrum', rare: true  },
        { name: 'raw_ostrum', input: 'ad_astra:raw_ostrum', output: 'forge_frontier:crushed_stellaris', rare: true  },
        { name: 'raw_calorite', input: 'ad_astra:raw_calorite', output: 'forge_frontier:crushed_pyroclast', rare: true  }
    ];
